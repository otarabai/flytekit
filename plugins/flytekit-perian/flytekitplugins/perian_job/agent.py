...
class PerianAgent(AsyncAgentBase):
    ...
    async def create(
        ...
        **kwargs,
        ...
        input_kwargs = TypeEngine.literal_map_to_kwargs(
            ctx, inputs, literal_types=literal_types) if inputs.literals else None
    ...
    def _build_create_job_request(self, task_template: TaskTemplate, inputs: Optional[Dict[str, Any]]) -> CreateJobRequest:
